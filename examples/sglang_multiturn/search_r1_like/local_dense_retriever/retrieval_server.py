...
if __name__ == "__main__":
    ...
    parser.add_argument("--index_path", type=str, default=os.getenv("MIRAI_INDEX_PATH"), help="Corpus index file.")
    parser.add_argument(
        "--corpus_path",
        type=str,
        default=os.getenv("MIRAI_CORPUS_PATH"),
    ...
    if not args.index_path or not args.corpus_path:
        parser.error("Set --index_path/--corpus_path or MIRAI_INDEX_PATH/MIRAI_CORPUS_PATH.")
