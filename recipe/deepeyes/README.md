...
Performance images used opaque signed external URLs and were removed from this redistributed snapshot. See the linked upstream pull-request discussion for archival context.
